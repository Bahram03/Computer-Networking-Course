...
void printdt3() {
    ...
    printf("   D0 |    0     1    2 \n");
    printf("------|-----------------\n");
    printf("     0|  %3d   %3d   %3d\n", dt3.costs[0][0], dt3.costs[0][1], dt3.costs[0][2]);
    printf("dest 1|  %3d   %3d   %3d\n", dt3.costs[1][0], dt3.costs[1][1], dt3.costs[1][2]);
    printf("     2|  %3d   %3d   %3d\n", dt3.costs[2][0], dt3.costs[2][1], dt3.costs[2][2]);
    printf("------------------------\n");
}
